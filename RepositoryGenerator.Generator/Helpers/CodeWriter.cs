...
namespace RepositoryGenerator.Generator.Helpers
{
    ...
    {
        internal static Source WriteRepositoryInterface(InterfaceToGenerate interfaceToGenerate)
        {
...
";
        ...
        internal static Source? WriteDIRegistration(ImmutableArray<ClassToGenerate?> classes)
        {
            ...
            sb.AppendLine();
            sb.AppendLine("public static class RepositoryGeneratorServiceCollectionExtensions");
            sb.AppendLine("{");
            sb.AppendLine(
